...
def main():
    pos_data_path = r"Data/pos_imdb_data.txt"
    neg_data_path = r"Data/neg_imdb_data.txt"

    no_embed_path = r"Data/imdb_no_embed.json"
    embed_path = r"Data/imdb_embed.json"
    ...
    data_embed = get_embeddings(data_json, task="clustering")
